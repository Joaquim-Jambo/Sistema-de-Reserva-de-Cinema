  ...
  const moviesData = [
    {
      ...
      categoryIds: ['6dfb3bf5-3dd1-445e-99d5-c1ec452a50d5', '42cef645-4a90-4b56-938b-bd0a52268bf3'],
      duration: '2h 28m',
      cast: 'Tom Holland, Zendaya, Benedict Cumberbatch',
      director: 'Jon Watts',
      premiereDate: new Date('2021-12-17'),
    ...
    },
    {
      ...
      premiereDate: new Date('2015-06-19'),
      distribuitor: 'Pixar Animation Studios',
      countryOfOrigin: 'USA'
    },
    {
      title: 'Inception',
  ...
  for (const m of moviesData) {
    const movie = await prisma.movie.upsert({
      ...
      create: {
        ...
        distribuitor: m.distribuitor,
        countryOfOrigin: m.countryOfOrigin
      }
    });

    // Connect categories via MovieCategory join table
    for (const categoryId of m.categoryIds) {
